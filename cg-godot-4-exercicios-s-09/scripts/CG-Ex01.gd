...
# Carrega a textura pa tileado
var textura_tile : Texture2D = load("res://Grass_Block.png")

# --- 2. Setup dos Vértices ---
...
func desenhar_tileado(verts: PackedVector2Array, pos: Vector2):
	...
	for v in verts:
		...
		uvs.append(uv * tile_factor) # Multiplica para fazer o tiling
